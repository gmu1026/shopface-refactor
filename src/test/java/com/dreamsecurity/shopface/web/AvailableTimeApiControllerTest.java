...
//                .andDo(document("AvailableTime_List_By_BranchNo"));
    ...
    public void 근무자의_자기_가용시간_목록조회_테스트() throws Exception {
        ...
        mockMvc.perform(get("/member/" + emp01.getId() + "/availabletime"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.data[0].startTime", is("2020-09-10 00:00:00")))
                .andExpect(jsonPath("$.data[0].endTime", is("2020-09-10 01:00:00")))
                .andExpect(jsonPath("$.data[1].startTime", is("2020-09-10 02:00:00")))
                .andExpect(jsonPath("$.data[1].endTime", is("2020-09-10 03:00:00")))
                .andExpect(jsonPath("$.data[2].startTime", is("2020-09-10 04:00:00")))
                .andExpect(jsonPath("$.data[2].endTime", is("2020-09-10 05:00:00")))
                .andExpect(jsonPath("$.data[3].startTime", is("2020-09-10 06:00:00")))
                .andExpect(jsonPath("$.data[3].endTime", is("2020-09-10 07:00:00")))
                .andExpect(jsonPath("$.data[4].startTime", is("2020-09-10 08:00:00")))
                .andExpect(jsonPath("$.data[4].endTime", is("2020-09-10 09:00:00")))
                .andExpect(jsonPath("$.data[5].startTime", is("2020-09-11 00:00:00")))
                .andExpect(jsonPath("$.data[5].endTime", is("2020-09-11 01:00:00")))
                .andExpect(jsonPath("$.data[6].startTime", is("2020-09-11 02:00:00")))
                .andExpect(jsonPath("$.data[6].endTime", is("2020-09-11 03:00:00")))
                .andExpect(jsonPath("$.data[7].startTime", is("2020-09-11 04:00:00")))
                .andExpect(jsonPath("$.data[7].endTime", is("2020-09-11 05:00:00")))
                .andExpect(jsonPath("$.data[8].startTime", is("2020-09-11 06:00:00")))
                .andExpect(jsonPath("$.data[8].endTime", is("2020-09-11 07:00:00")))
                .andExpect(jsonPath("$.data[9].startTime", is("2020-09-11 08:00:00")))
                .andExpect(jsonPath("$.data[9].endTime", is("2020-09-11 09:00:00")))
